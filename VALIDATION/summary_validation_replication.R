...
row2<-c('Consistency','Factually consistent with the advertisement',round(as.numeric(row2_test$estimate[2]),2),round(as.numeric(row2_test$estimate[1]),2),round(abs(as.numeric(row2_test$statistic)),3),round(abs(as.numeric(row2_test$p.value)),3))
...
row3<-c('Fluency','Contains the main themes of the advertisement',round(as.numeric(row3_test$estimate[2]),2),round(as.numeric(row3_test$estimate[1]),2),round(abs(as.numeric(row3_test$statistic)),3),round(abs(as.numeric(row3_test$p.value)),3))
...
row4<-c('Relevancy','Useful for research on presidential advertisements',round(as.numeric(row4_test$estimate[2]),2),round(as.numeric(row4_test$estimate[1]),2),round(abs(as.numeric(row4_test$statistic)),3),round(abs(as.numeric(row4_test$p.value)),3))
...
row5<-c('Overall','',round(as.numeric(row5_test$estimate[2]),2),round(as.numeric(row5_test$estimate[1]),2),round(abs(as.numeric(row5_test$statistic)),3),round(abs(as.numeric(row5_test$p.value)),3))
...
###          Create our t-test table            ###
### ### ### ### ### ### ### ### ### ### ### ### ###
Wrow1_test<-wilcox.test(rowmeans_human_df[rowmeans_human_df $question_type=='coherent', 'meanrating'], rowmeans_GPT_df[rowmeans_GPT_df $question_type=='coherent', 'meanrating'], paired=T)               
Wrow1<-c('Coherence','Coherent and easy to understand', 
    round(abs(as.numeric(Wrow1_test$statistic)),3),round(abs(as.numeric(Wrow1_test$p.value)),3))

Wrow2_test<-wilcox.test(rowmeans_human_df[rowmeans_human_df $question_type=='factual', 'meanrating'], rowmeans_GPT_df[rowmeans_GPT_df $question_type=='factual', 'meanrating'], paired=T)    
Wrow2<-c('Consistency','Factually consistent with the advertisement',
round(abs(as.numeric(Wrow2_test$statistic)),3),round(abs(as.numeric(Wrow2_test$p.value)),3))

Wrow3_test<-wilcox.test(rowmeans_human_df[rowmeans_human_df $question_type=='themes', 'meanrating'], rowmeans_GPT_df[rowmeans_GPT_df $question_type=='themes', 'meanrating'], paired=T)  
Wrow3<-c('Fluency','Contains the main themes of the advertisement',
round(abs(as.numeric(Wrow3_test$statistic)),3),round(abs(as.numeric(Wrow3_test$p.value)),3))

Wrow4_test<-wilcox.test(rowmeans_human_df[rowmeans_human_df $question_type=='useful', 'meanrating'], rowmeans_GPT_df[rowmeans_GPT_df $question_type=='useful', 'meanrating'], paired=T)  
Wrow4<-c('Relevancy','Useful for research on presidential advertisements',
round(abs(as.numeric(Wrow4_test$statistic)),3),round(abs(as.numeric(Wrow4_test$p.value)),3))

Wrow5_test<-wilcox.test(rowmeans_human_df_comb4$x, rowmeans_GPT_df_comb4$x,  paired=T)
Wrow5<-c('Overall','',
...
colnames(wresults)<-c('Dimension','Definition','V','p-value')
wresults
